<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Games.aspx.cs" Inherits="Gamestore1.Pages.Admin.Games"
        MasterPageFile="~/Pages/Admin/Admin.Master" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="Gamestore1.Models.Game" SelectMethod="GetGames"
